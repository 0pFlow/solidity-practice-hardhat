...
contract Wallet {
    ...
    // Funktion som anropas om någon försöker anropa en funktion som inte existerar
    fallback() external {
        emit FallbackCalled(msg.sender);
        revert("Fallback function called. This function does not exist. Try another one.");
    }

    // Funktion som anropas om någon för över ETH till vårt kontrakt, utan att kalla på en funktion
    receive() external payable {
        // Vi hänvisar till vår deposit-funktion
        deposit();
    }
